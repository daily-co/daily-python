...
class CallClient:
    ...
    def leave(self, completion: Optional[Callable[[Optional[str]], None]] = None) -> None: ...
    ...
    def eject_remote_participants(
        self, ids: List[str], completion: Optional[Callable[[Optional[str]], None]] = None
    ) -> None: ...
    ...
    def update_subscription_profiles(
        self,
    ...
    def start_live_stream_with_rtmp_urls(
        self,
    ...
    def add_live_streaming_endpoings(
        self,
        endpoints: List[str],
        stream_id: Optional[str] = None,
        completion: Optional[Callable[[Optional[str]], None]] = None,
    ...
    def remove_live_streaming_endpoings(
        self,
        endpoints: List[str],
        stream_id: Optional[str] = None,
        completion: Optional[Callable[[Optional[str]], None]] = None,
    ...
    def stop_transcription(
        self, completion: Optional[Callable[[Optional[str]], None]] = None
    ) -> None: ...
...
class EventHandler:
    ...
    def on_subscription_profiles_updated(
        self, subscription_profiles: Mapping[str, Any]
    ) -> None: ...
